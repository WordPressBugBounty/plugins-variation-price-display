...
**Variation Price Display for WooCommerce** now supports **WooCommerce Grouped products**.

Like the WooCommerce Variable Products, would you love to remove the default price range for your grouped products? Now, you can apply the same price customizations for your grouped products too.
...
This option will remove the main product name when you enable the List all variation price from the Price Types option.
...
🔥 **Support for WooCommerce Grouped Products**
All price customization options are available for WooCommerce grouped products.
...
= 1.3.12 [21-02-2024] =
* Added: New hook `vpd_format_sale_price_display`.
* Added: `vpd_script_init` trigger to reinitialize the plugin script.
